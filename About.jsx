    ...
    <div className="container py-10 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <div className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-xs">
          ...
          <p className="text-sm text-gray-600 leading-relaxed mb-4">
            Unlike commercial gig intermediaries that extract high commissions without providing long-term security, Sahakari SevaSetu is built on the cooperative ethos: <strong>workers are member-owners</strong>.
          </p>
        ...
        <div className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-xs">
          ...
          <p className="text-sm text-gray-600 leading-relaxed mb-4">
            Every gig completed on Sahakari SevaSetu contributes directly to social security, accident coverage, continuous trade certification, and health support.
          </p>
          <ul className="space-y-2 text-xs text-gray-700">
            <li className="flex items-center gap-2">
              <CheckCircle2 size={14} className="text-green-700 shrink-0" />
      ...
      <div className="text-center bg-amber-50 p-8 rounded-xl border border-amber-200">
        ...
        <p className="text-xs text-gray-600 max-w-md mx-auto mb-4">
          Whether you need a trustworthy service provider or wish to join as a skilled worker member, Sahakari SevaSetu is your platform.
        </p>
