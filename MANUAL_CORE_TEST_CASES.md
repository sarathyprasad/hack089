...
| **8** | **Audit Section 2: Trade Licenses & Certifications.** | Review Trade Qualifications. | Displays: Skill Certificate Number (e.g., `CERT-BBSR-2014-E1024`), Issuing Organization (e.g., *State Skill Council Bhubaneswar*), Issue Date, and NCVT/CESL License. | Trade qualification verified. |
