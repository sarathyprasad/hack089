...
export const TRANSLATIONS = {
  EN: {
    ...
    portalSubHeader: 'Government of Odisha • Labour Cooperative Federation Portal',
    brandName: 'Sahakari SevaSetu',
    ...
    heroSubtitle: 'Connect with certified, background-verified skilled professionals affiliated with regional Labour Cooperative Federations across Odisha. Regulated tariffs, zero surge pricing, and direct social security.',
  ...
  HI: {
    ...
    portalSubHeader: 'ओडिशा सरकार • श्रम सहकारी महासंघ पोर्टल',
    brandName: 'सहकारी सेवासेतु',
  ...
  OR: {
    ...
    portalSubHeader: 'ଓଡ଼ିଶା ସରକାର • ଶ୍ରମ ସମବାୟ ମହାସଂଘ ପୋର୍ଟାଲ',
    brandName: 'ସହକାରୀ ସେବାସେତୁ',
  ...
  BN: {
    ...
    portalSubHeader: 'ওড়িশা সরকার • শ্রম সমবায় ফেডারেশন পোর্টাল',
    brandName: 'সহকারী সেবা সেতু',
  ...
  TE: {
    ...
    portalSubHeader: 'ఒడిశా ప్రభుత్వం • లేబర్ కోఆపరేటివ్ ఫెడరేషన్ పోర్టల్',
    brandName: 'సహకారి సేవాసేతు',
