          ...
          <div className="border-b-2 border-blue-900 pb-5 flex items-start justify-between">
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-gray-500">
                Registered under Odisha Cooperative Societies Act, 1962 • Reg No: <span className="font-mono font-bold text-gray-700">{activeInvoice.cooperative_reg || 'COOP-OD-2024-001'}</span>
              </p>
