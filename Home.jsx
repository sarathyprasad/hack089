...
export default function Home() {
  ...
  const handleHeroSpeech = () => {
    ...
    const currentText = {
      EN: "Welcome to Sahakari SevaSetu, the official Government Cooperative Labour Services Portal. Verified skills, fair wages, zero surge pricing, and direct social security for all artisans. You can book an electrician, plumber, carpenter, or appliance mechanic online or dial toll free 1800-345-7788.",
              ...
              >
                ...
                <div className="pt-3 border-t border-gray-100 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 pt-1">
                    ...
                    <Link
                      to={`/book-service?category=${encodeURIComponent(cat.categoryName)}&serviceId=${cat.id}`}
