...
const FAQS = [
  {
    q: 'How does Sahakari SevaSetu verify worker credentials?',
    a: 'Every worker registered on Sahakari SevaSetu is affiliated with a licensed District Labour Cooperative. Government ITI certificates, NSDC skill cards, and state trade licenses are physically and digitally verified by the Cooperative Administration before activation.',
  },
  {
